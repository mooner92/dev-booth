...
# --------------------------------------------------------------------------
# Per-skill use-case registry (v7). Keys are Hermes skill names; values are
# one-line Korean use-case descriptions shown in every stage body so the
# model can decide whether to load a skill on that turn.
# --------------------------------------------------------------------------
...
"""),
    ...
    StageTask(
        ...
        parent_stages=[7],
        skills=["test-driven-development", "systematic-debugging", "subagent-driven-development"],
        body_template="""## 작업
